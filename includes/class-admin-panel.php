                    ...
                    <div class="aisc-card">
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input type="radio" name="aisc_settings[ai_provider]" value="anthropic" <?php checked( $s['ai_provider'], 'anthropic' ); ?>>
                                        Anthropic Claude (Recomendado)
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[ai_provider]" value="google" <?php checked( $s['ai_provider'], 'google' ); ?>>
                                        Google Gemini
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[ai_provider]" value="openrouter" <?php checked( $s['ai_provider'], 'openrouter' ); ?>>
                                        OpenRouter
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="password" id="api_key" name="aisc_settings[api_key]"
                                        value="<?php echo esc_attr( $s['api_key'] ); ?>"
                                        class="regular-text" placeholder="sk-ant-api03-...">
                                    <p class="description">
                                        <a href="https://console.anthropic.com" target="_blank">Obtener key en console.anthropic.com</a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="password" id="google_key" name="aisc_settings[google_key]"
                                        value="<?php echo esc_attr( $s['google_key'] ); ?>"
                                        class="regular-text" placeholder="AIza...">
                                    <p class="description">
                                        <a href="https://aistudio.google.com" target="_blank">Obtener key en aistudio.google.com</a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="password" id="openrouter_key" name="aisc_settings[openrouter_key]"
                                        value="<?php echo esc_attr( $s['openrouter_key'] ); ?>"
                                        class="regular-text" placeholder="sk-or-v1-...">
                                    <p class="description">
                                        <a href="https://openrouter.ai/keys" target="_blank">Obtener key en openrouter.ai</a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" id="max_tokens" name="aisc_settings[max_tokens]"
                                        value="<?php echo esc_attr( $s['max_tokens'] ); ?>"
                                        min="256" max="8192" class="small-text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" id="temperature" name="aisc_settings[temperature]"
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="system_prompt" name="aisc_settings[system_prompt]"
                                        rows="5" class="large-text"><?php echo esc_textarea( $s['system_prompt'] ); ?></textarea>
                                    <p class="description">Define la personalidad y comportamiento de tu asistente IA</p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="aisc-card">
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="widget_title" name="aisc_settings[widget_title]"
                                        value="<?php echo esc_attr( $s['widget_title'] ); ?>"
                                        class="regular-text">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="color" id="widget_color" name="aisc_settings[widget_color]"
                                        value="<?php echo esc_attr( $s['widget_color'] ); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>Posicion</th>
                                <td>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_position]" value="bottom-right" <?php checked( $s['widget_position'], 'bottom-right' ); ?>>
                                        Abajo Derecha
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_position]" value="bottom-left" <?php checked( $s['widget_position'], 'bottom-left' ); ?>>
                                        Abajo Izquierda
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_position]" value="top-right" <?php checked( $s['widget_position'], 'top-right' ); ?>>
                                        Arriba Derecha
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_position]" value="top-left" <?php checked( $s['widget_position'], 'top-left' ); ?>>
                                        Arriba Izquierda
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_size]" value="small" <?php checked( $s['widget_size'], 'small' ); ?>>
                                        Pequeno (320x380px)
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_size]" value="medium" <?php checked( $s['widget_size'], 'medium' ); ?>>
                                        Mediano (380x450px)
                                    </label><br>
                                    <label>
                                        <input type="radio" name="aisc_settings[widget_size]" value="large" <?php checked( $s['widget_size'], 'large' ); ?>>
                                        Grande (460x580px)
                                    </label>
                                </td>
                            </tr>
